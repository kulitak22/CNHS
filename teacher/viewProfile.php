  ...
  <div class="container" >
    <div class="title">Pesonal Information</div>
      ...
      $conn = mysqli_connect($sname, 
        ...
        $sqls = "SELECT * FROM `tblteacher` WHERE `teacherid` = '$id' ;";
        ...
        <input type="hidden" name="id" value="<?php echo $row['teacherid']?>">
          <div class="user-details">
            <div class="input-box">
              ...
              <input type="text" name="fname" value="<?php echo $row['name']?>" disabled="disabled">
              <!-- ===== Suffix ===== -->
              <span class="details">Suffix</span>
              <select name="extname" class="select-box" aria-placeholder="sa" disabled="disabled"> 
              ...
              <input type="text" name="address" value="<?php echo $row['address']?>" disabled="disabled">
              <!-- ===== Religion ===== -->
            <span class="details">Religion</span>
            <input type="text" name="religion" value="<?php echo $row['religion']?>" disabled="disabled">
            ...
            <span class="details">Middle Name</span>
              <input type="text" name="mname" value="<?php echo $row['mname']?>" disabled="disabled">
              <!-- ===== Gender ===== -->
              <span class="details">Gender</span>
              <select name="gender" class="select-box" disabled="disabled">
            ...
            <input type="number" name="age" value="<?php echo $row['age']?>" disabled="disabled">
            <!-- ===== Contact No ===== -->
            <span class="details">Contact No.</span>
            <input type="number" name="contact" value="<?php echo $row['contact']?>" disabled="disabled">
            <!-- ===== Nationality ===== -->
            <span class="details">Nationality</span>
            <input type="text" name="nationality" value="<?php echo $row['nationality']?>" disabled="disabled">
            ...
            <span class="details">Last Name</span>
              <input type="text" name="lname" value="<?php echo $row['lname']?>" disabled="disabled">
              <!-- ===== Civil Status ===== -->
              <span class="details">Civil Status</span>
              <select name="cstatus" class="select-box" disabled="disabled">
            ...
            <input type="text" name="bdate" value="<?php echo $row['bdate']?>"disabled="disabled">
      ...
      ?>
          ...
          <div class="user-details">
            ...
            <span class="details">Title</span>
              ...
              <select name="title" class="select-box" disabled="disabled">
            ...
            <div class="input-box">
              ...
              <select name="sy" class="select-box" disabled="disabled">
            ...
            <span class="details">Advisory</span>
              <select name="advisory" class="select-box" disabled="disabled">
